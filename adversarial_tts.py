...
def parse_arguments():
    ...
    parser.add_argument("--thresholds", nargs='*', type=str, default=["PESQ=0.2", "WER_GT=0.5"], help="Early stopping thresholds. Format: OBJ=Val (e.g. --thresholds PESQ=0.35 WER_GT=0.05)")
